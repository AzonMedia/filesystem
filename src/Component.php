...
class Component extends BaseComponent
{
    ...
    protected const COMPONENT_NAME = "Filesystem package";
    protected const COMPONENT_URL = 'https://filesystem.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/filesystem/docs/ErrorReference/';
}